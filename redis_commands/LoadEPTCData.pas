...
type
  ...
  public
    ...
    constructor Create(const ADirName: string; ALog: TProcessLine); reintroduce;
  end;
...
constructor TLoadEPTC.Create(const ADirName: string; ALog: TProcessLine);
begin
  inherited Create;
  Self.FDirName := ADirName;
  Self.FLog     := ALog;
end;
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              oRedis.GEOADD(sKeyName, rParada.Latidude, rParada.Longitude, rParada.IDParada);
            end;
          end;
        end;
      end;
